        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiscountPercentage = table.Column<decimal>(type: "TEXT", precision: 18, scale: 2, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ServiceId = table.Column<int>(type: "INTEGER", nullable: false),
                    ServiceOptionId = table.Column<int>(type: "INTEGER", nullable: true),
                    Price = table.Column<decimal>(type: "TEXT", precision: 18, scale: 2, nullable: false),
                    DurationMinutes = table.Column<int>(type: "INTEGER", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "CreatedAt", "CreatedBy", "IsDeleted", "Name", "ParentCategoryId", "Slug", "UpdatedAt", "UpdatedBy" },
                values: new object[] { 1, new DateTime(2025, 11, 16, 0, 0, 0, 0, DateTimeKind.Utc), null, false, "Plumbing", null, "plumbing", null, null });
            ...
            migrationBuilder.InsertData(
                table: "Services",
                columns: new[] { "Id", "BasePrice", "CategoryId", "CityId", "CreatedAt", "CreatedBy", "DurationMinutes", "IsActive", "IsDeleted", "LongDescription", "ShortDescription", "Title", "UpdatedAt", "UpdatedBy" },
                values: new object[] { 1, 499.00m, 1, 1, new DateTime(2025, 11, 16, 0, 0, 0, 0, DateTimeKind.Utc), null, 60, true, false, "Basic leakage repair service for taps, pipelines.", "Fix home leakages", "Leakage Repair", null, null });
